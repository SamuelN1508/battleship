...
class Ending(tk.Frame):
	...
	def __init__(self, parent, Game):
		...
		self.ending_logo = ImageTk.PhotoImage(image)
		self.label_ending_logo = tk.Label(self.main_frame, image=self.ending_logo)
		self.label_ending_logo.pack(padx=10, pady=50)
